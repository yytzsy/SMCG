...
class ONLSTMCell(nn.Module):
    ...
    def __init__(self, dim_parse, input_size, hidden_size, dropconnect=0.):
...
class ONLSTMStack(nn.Module):
    def __init__(self, dim_parse, layer_sizes, dropout=0., dropconnect=0.):
        super(ONLSTMStack, self).__init__()
        self.cells = nn.ModuleList([ONLSTMCell(dim_parse,
                                               layer_sizes[i],
                                               layer_sizes[i+1],
