...
class Attention(nn.Module):
    ...
    def __init__(self, dim, dim_encoder, num_layers):
        super(Attention, self).__init__()
        self.dim = dim
        self.num_layers = num_layers
        self.linear1 = nn.Linear(dim_encoder + dim * self.num_layers, dim)
