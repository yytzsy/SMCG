...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--caption_json', default='../video-caption.pytorch-master/data/caption.json',
                        help='input json file to containing video captions')
    parser.add_argument('--info_json', default='../video-caption.pytorch-master/data/info.json', help='vocab info json file')
    parser.add_argument('--output_pkl', default='../video-caption.pytorch-master/data/msr-all', help='output pickle file')
